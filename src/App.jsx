...
var CRIME_DATABASE = {
  ...
  "Stefon Diggs": { sport: "NFL", team: "New England Patriots", position: "WR", added: "2026-03-11", crimes: [{ year: 2025, charge: "Felony strangulation or suffocation & misdemeanor assault and battery (alleged assault of personal chef)", outcome: "Pleaded not guilty, pretrial hearing scheduled April 2026" }], status: "Active in NFL, case pending" },
  "Terry Rozier": { sport: "NBA", team: "Miami Heat", position: "PG", added: "2026-03-11", crimes: [{ year: 2025, charge: "Illegal sports betting scheme using insider NBA information, conspiracy to commit wire fraud", outcome: "Arrested October 2025, case pending" }], status: "Placed on immediate NBA leave" },
  "Chauncey Billups": { sport: "NBA", team: "Portland Trail Blazers (Coach)", position: "Head Coach", added: "2026-03-11", crimes: [{ year: 2025, charge: "Conspiracy to commit wire fraud & money laundering (rigged underground poker games linked to organized crime)", outcome: "Arrested October 2025, case pending" }], status: "Removed as head coach" },
  "Kadarius Toney": { sport: "NFL", team: "Kansas City Chiefs / Browns", position: "WR", added: "2026-03-11", crimes: [{ year: 2025, charge: "Aggravated assault by strangulation & obstructing 911 calls (domestic violence against pregnant girlfriend)", outcome: "Arrested February 2025, case pending" }], status: "Released by NFL teams" },
  "Robert Quinn": { sport: "NFL", team: "Philadelphia Eagles / Multiple", position: "DE", added: "2026-03-11", crimes: [{ year: 2023, charge: "Hit-and-run, assault (crashed into parked car, assaulted occupant, fled)", outcome: "Arrested, charged" }, { year: 2025, charge: "Hit-and-run, resisting arrest (crashed truck into parked car, attempted to flee, fought police)", outcome: "Arrested January 2025" }], status: "Out of NFL" },
  "Terrell Suggs": { sport: "NFL", team: "Baltimore Ravens", position: "OLB", added: "2026-03-11", crimes: [{ year: 2009, charge: "Domestic assault allegations", outcome: "Restraining order issued, firearms surrendered, no charges" }, { year: 2024, charge: "Threatening & intimidating, disorderly conduct with a weapon (road rage incident at Starbucks)", outcome: "Arrested April 2024, case pending" }], status: "Retired" },
  "Calvin Ridley": { sport: "NFL", team: "Atlanta Falcons / Jacksonville Jaguars", position: "WR", added: "2026-03-11", crimes: [{ year: 2022, charge: "Illegal gambling on NFL games while away from team", outcome: "Suspended entire 2022 season by NFL" }], status: "Returned to NFL" },
  "Paul Pierce": { sport: "NBA", team: "Boston Celtics", position: "SF", added: "2026-03-11", crimes: [{ year: 2023, charge: "SEC charges for false & misleading statements about cryptocurrency promotion", outcome: "Ordered to pay $1.4 million" }, { year: 2025, charge: "DUI (found asleep in car on freeway)", outcome: "Arrested October 2025" }], status: "Retired, Hall of Famer" },
  "Lenny Dykstra": { sport: "MLB", team: "New York Mets / Philadelphia Phillies", position: "OF", added: "2026-03-11", crimes: [{ year: 2011, charge: "Bankruptcy fraud, money laundering, concealment of assets", outcome: "Convicted, sentenced to 6.5 months prison" }, { year: 2012, charge: "Grand theft auto, drug possession, identity theft", outcome: "Sentenced to 3 years prison" }], status: "Served sentences" },
  "Lawrence Phillips": { sport: "NFL", team: "St. Louis Rams / Multiple", position: "RB", added: "2026-03-11", crimes: [{ year: 1996, charge: "Assault (dragged girlfriend down stairs by her hair)", outcome: "6 games suspension at Nebraska, pleaded no contest" }, { year: 2005, charge: "Assault with a motor vehicle (drove car into three teenagers)", outcome: "Convicted, 10 years prison" }, { year: 2010, charge: "Murder (strangling cellmate in prison)", outcome: "Charged with first-degree murder" }], status: "Deceased (2016, suicide in prison)" },
  "Ezekiel Elliott": { sport: "NFL", team: "Dallas Cowboys", position: "RB", added: "2026-03-11", crimes: [{ year: 2016, charge: "Domestic violence allegations (ex-girlfriend, multiple incidents)", outcome: "No criminal charges; 6-game NFL suspension after league investigation" }], status: "Active in NFL" },
  "Ben Roethlisberger": { sport: "NFL", team: "Pittsburgh Steelers", position: "QB", added: "2026-03-11", crimes: [{ year: 2008, charge: "Sexual assault allegation (Lake Tahoe hotel employee)", outcome: "Civil suit, settled out of court" }, { year: 2010, charge: "Sexual assault allegation (college student in Georgia nightclub)", outcome: "No criminal charges; 6-game NFL suspension (reduced to 4)" }], status: "Retired" },
  "Dani Alves": { sport: "Soccer (La Liga)", team: "FC Barcelona", position: "RB", added: "2026-03-11", crimes: [{ year: 2023, charge: "Sexual assault (woman at Barcelona nightclub)", outcome: "Convicted, sentenced to 4.5 years prison" }], status: "Incarcerated, appealing" },
  "Ryan Leaf": { sport: "NFL", team: "San Diego Chargers", position: "QB", added: "2026-03-11", crimes: [{ year: 2009, charge: "Burglary & drug charges (broke into homes to steal painkillers)", outcome: "Convicted, sentenced to probation" }, { year: 2012, charge: "Burglary, theft, criminal possession of dangerous drugs", outcome: "Convicted, sentenced to 5 years prison (served 2)" }], status: "Released, now works in recovery advocacy" },
  "Metta Sandiford-Artest": { sport: "NBA", team: "Indiana Pacers / Lakers", position: "SF", added: "2026-03-11", crimes: [{ year: 2004, charge: "Assault (Malice at the Palace)", outcome: "73-game suspension, misdemeanor charge" }], status: "Retired" },
  "Christian Barmore": { sport: "NFL", team: "New England Patriots", position: "DT", added: "2026-03-11", crimes: [{ year: 2025, charge: "Domestic assault (alleged August incident in Mansfield, MA)", outcome: "Arraignment scheduled, case pending" }], status: "Active in NFL" },
  "Maurice Clarett": { sport: "NFL", team: "Denver Broncos", position: "RB", added: "2026-03-11", crimes: [{ year: 2006, charge: "Aggravated robbery (robbed two people at gunpoint)", outcome: "Guilty plea, 3.5 years prison" }], status: "Served sentence, became motivational speaker" },
  "Darrell Armstrong": { sport: "NBA", team: "Orlando Magic / Multiple", position: "PG", added: "2026-03-11", crimes: [{ year: 2025, charge: "Family violence battery (domestic violence arrest)", outcome: "Arrested, case pending" }], status: "Former NBA assistant coach" },
  "Rafael Furcal": { sport: "MLB", team: "Atlanta Braves / Dodgers / Cardinals", position: "SS", added: "2026-03-11", crimes: [{ year: 2025, charge: "Assault (throwing rocks at another driver during road rage incident)", outcome: "Arrested, charges filed" }], status: "Retired" },
  "Chad Johnson (Ochocinco)": { sport: "NFL", team: "Cincinnati Bengals / Miami Dolphins", position: "WR", added: "2026-03-11", crimes: [{ year: 2012, charge: "Domestic battery (headbutted wife Evelyn Lozada)", outcome: "Guilty plea to misdemeanor, 12 months probation" }], status: "Released by Dolphins, career ended" },
};
    ...
    <div style={{minHeight:"100vh",background:bg,color:textMain,position:"relative",overflow:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:2,maxWidth:800,margin:"0 auto",padding:"40px 20px 60px"}}>
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:12,marginBottom:20}}>
          ...
          <div>
            <div style={{fontFamily:"'JetBrains Mono', monospace",fontSize:10,color:accent,letterSpacing:2,textTransform:"uppercase",marginBottom:6,fontWeight:600,textAlign:"left"}}>FILTER</div>
